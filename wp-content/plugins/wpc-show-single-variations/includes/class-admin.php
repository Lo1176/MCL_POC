					...
					<?php } elseif ( $active_tab === 'tools' ) { ?>
                        <table class="form-table">
                            <tr>
                                ...
                                <td>
									<?php if ( isset( $_GET['act'] ) && ( $_GET['act'] === 'init' ) ) {
										$args = array(
										...
										echo '<div>' . esc_html__( 'Finished!', 'wpc-show-single-variations' ) . '</div>';
									}
									?>
                                    <a class="button btn"
                                       href="<?php echo admin_url( 'admin.php?page=wpclever-woosv&tab=tools&act=init' ); ?>"><?php esc_html_e( 'Re-init variations', 'wpc-show-single-variations' ); ?></a>
                                    <p class="description">
										<?php esc_html_e( 'Re-init variations\' data to make it works with product category/tag. This process may take a while.', 'wpc-show-single-variations' ); ?>
                                    </p>
                                </td>
                            </tr>
                        </table>
