...
function bs_share_buttons($content) {
    ...
    if(is_singular() || is_home()){
       ...
       if(!empty($bs_thumb)) {
        ...
        $content .= '<a class="mb-1 btn btn-sm btn-pinterest d-none" title="Pinterest" href="'.$pinterestURL.'" data-pin-custom="true" target="_blank" rel="nofollow"><i class="fab fa-pinterest-p"></i></a> ';
        ...
        $content .= '<a class="mb-1 btn btn-sm btn-reddit d-none" title="Reddit" href="'.$redditURL.'" target="_blank" rel="nofollow"><i class="fab fa-reddit-alien"></i></a> '; 
        $content .= '<a class="mb-1 btn btn-sm btn-tumblr d-none" title="Tumblr" href="'.$tumblrURL.'" target="_blank" rel="nofollow"><i class="fab fa-tumblr"></i></a> ';
        $content .= '<a class="mb-1 btn btn-sm btn-buffer d-none" title="Buffer" href="'.$bufferURL.'" target="_blank" rel="nofollow"><i class="fab fa-buffer"></i></a> ';
        $content .= '<a class="mb-1 btn btn-sm btn-mix d-none" title="mix" href="'.$mixURL.'" target="_blank" rel="nofollow"><i class="fab fa-mix"></i></a> ';
        $content .= '<a class="mb-1 btn btn-sm btn-vk d-none" title="vk" href="'.$vkURL.'" target="_blank" rel="nofollow"><i class="fab fa-vk"></i></a> ';
