...
class RP_Decorator
{
    ...
    public function __construct()
    {
        // Use our templates instead of woocommerce.
         add_filter( 'woocommerce_locate_template', array( $this, 'wt_localize_templates' ), 10, 3 );
        // Load translation
    ...
    public function plugins_page_links($links)
    {
	    ...
	    $plugin_links = array( '<a href="' . RP_Decorator_Customizer::get_customizer_url() . '"  target="_blank">' . __( 'Customise Email', 'decorator-woocommerce-email-customizer' ) . '</a>',
                '<a href="https://www.webtoffee.com/decorator-woocommerce-email-customizer-plugin-user-guide/"  target="_blank">' . __( 'Documentation', 'decorator-woocommerce-email-customizer' ) . '</a>',
