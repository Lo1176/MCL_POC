        ...
        <form class="woocommerce-form woocommerce-form-login login" method="post">
          ...
          <div class="row my-1">
            ...
            <p class="col-12 col-sm-6 form-check">
              ...
              <label class="coco form-check-label" for="rememberme"><?php _e('Remember me', 'woocommerce'); ?></label>
            </p>
          ...
          <p class="form-row">
            ...
            <button type="submit" class="woocommerce-form-login__submit col-12 col-sm-3 btn btn-dark" name="login" value="<?php esc_attr_e('Log in', 'woocommerce'); ?>"><?php esc_html_e('Log in', 'woocommerce'); ?></button>
          </p>
      ...
      <div class="card mt-3">
        ...
        <form method="post" class="card-body" <?php do_action('woocommerce_register_form_tag'); ?>>
          ...
          <p class="woocommerce-form-row form-row mb-0">
            ...
            <button type="submit" class="col-12 col-sm-3 btn btn-dark woocommerce-form-register__submit" name="register" value="<?php esc_attr_e('Register', 'woocommerce'); ?>"><?php esc_html_e('Register', 'woocommerce'); ?></button>
          </p>
