...
<div id="content" class="site-content">
  <div id="primary" class="content-area">
    ...
    <main id="main" class="site-main">
      ...
      <header class="entry-header featured-full-width-img-brand text-light mb-3" style="background-image: url('<?php echo $thumb['0']; ?>')">
                ...
                <div id="collection" class="d-flex justify-content-center justify-content-sm-start flex-wrap">
                  ...
                  <div class="card">
                    <a href="<?php echo do_shortcode('[homeurl]/categorie-produit/origine/'); ?>">
                      <!-- <img class="card-img-top" src="<?php #echo do_shortcode('[homeurl]/wp-content/uploads/2021/11/lw-origine-scaled.jpg'); ?>" alt="Produc image cat"> -->
                  ...
                  <div class="card">
                    <a href="<?php echo do_shortcode('[homeurl]/categorie-produit/prestige/'); ?>">
                      <!-- <img class="card-img-top" src="<?php #echo do_shortcode('[homeurl]/wp-content/uploads/2021/11/lw-origine-prestige-scaled.jpg'); ?>" alt="Produc image cat"> -->
                      <img class="card-img-top" src="<?php echo do_shortcode('[homeurl]/wp-content/uploads/2021/11/lw-iroquois-colors-tbe.png'); ?>" alt="Produc image cat">
                      <div class="card-body">
                  ...
                  <div class="card">
                    <a href="<?php echo do_shortcode('[homeurl]/categorie-produit/signature/'); ?>">
                      <!-- <img class="card-img-top" src="<?php #echo do_shortcode('[homeurl]/wp-content/uploads/2021/11/lw-signature.png'); ?>" alt="Produc image cat"> -->
                      <img class="card-img-top" src="<?php echo do_shortcode('[homeurl]/wp-content/uploads/2021/11/lw-iroquois-colors-tbe.png'); ?>" alt="Produc image cat">
                      <div class="card-body">
                  ...
                  <div class="card">
                    <a href="<?php echo do_shortcode('[homeurl]/categorie-produit/iroquois-zinc/'); ?>">
                      <!-- <img class="card-img-top" src="<?php #echo do_shortcode('[homeurl]/wp-content/uploads/2021/11/lw-iroquois-zinc-tbe.png'); ?>" alt="Produc image cat"> -->
                      <img class="card-img-top" src="<?php echo do_shortcode('[homeurl]/wp-content/uploads/2021/11/lw-iroquois-colors-tbe.png'); ?>" alt="Produc image cat">
                      <div class="card-body">
                  ...
                  <div class="card">
                    <a href="<?php echo do_shortcode('[homeurl]/categorie-produit/iroquois-wood/'); ?>">
                      <!-- <img class="card-img-top" src="<?php #echo do_shortcode('[homeurl]/wp-content/uploads/2021/11/lw-iroquois-wood-tbe.png'); ?>" alt="Produc image cat"> -->
                      <img class="card-img-top" src="<?php echo do_shortcode('[homeurl]/wp-content/uploads/2021/11/lw-iroquois-colors-tbe.png'); ?>" alt="Produc image cat">
                      <div class="card-body">
                  ...
                  <div class="card">
                    <a href="<?php echo do_shortcode('[homeurl]/categorie-produit/essentiel/'); ?>">
                      <!-- <img class="card-img-top" src="<?php #echo do_shortcode('[homeurl]/wp-content/uploads/2021/11/lw-essentiel.jpg'); ?>" alt="Produc image cat"> -->
                      <img class="card-img-top" src="<?php echo do_shortcode('[homeurl]/wp-content/uploads/2021/11/lw-iroquois-colors-tbe.png'); ?>" alt="Produc image cat">
                      <div class="card-body">
                  ...
                  <div class="card">
                    <a href="<?php echo do_shortcode('[homeurl]/categorie-produit/kit-sommelier/'); ?>">
                      <!-- <img class="card-img-top" src="<?php #echo do_shortcode('[homeurl]/wp-content/uploads/2021/11/lw-kit-scaled.jpg'); ?>" alt="Produc image cat"> -->
                      <img class="card-img-top" src="<?php echo do_shortcode('[homeurl]/wp-content/uploads/2021/11/lw-iroquois-colors-tbe.png'); ?>" alt="Produc image cat">
                      <div class="card-body">
