jQuery(document).ready(function ($) {
  ...
  // // function to fix the header on scroll => they prefer to fix the header
  ...
  //   });
  // }
  // // function to fix the header end 
  ...
  $(".single_add_to_cart_button, button.product_type_simple").prop(
    "disabled",
    false
  );
